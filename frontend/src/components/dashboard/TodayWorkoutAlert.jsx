...
return (<div className="bg-surface shadow-neu rounded-3xl p-8 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 border-none">
            ...
            <div className="flex items-center gap-6 z-10 w-full md:w-auto">
                ...
                <div>
                    <h3 className="text-[10px] font-black text-primary tracking-[0.2em] uppercase mb-1">Today's Workout</h3>
            ...
            <Button variant="primary" size="lg" className="w-full md:w-auto px-10 rounded-2xl z-10 font-black uppercase tracking-widest shadow-neu-primary/10" onClick={onStart}>
                Start Workout
            </Button>
        </div>);
}
