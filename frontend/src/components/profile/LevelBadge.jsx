    ...
    return (<div className="bg-app shadow-neu rounded-3xl p-5 border border-divider">
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-primary shadow-neu flex items-center justify-center text-white text-xl font-black">
                        {level}
                    </div>
                    <div>
                        <h3 className="text-sm font-black uppercase tracking-widest text-text-primary">Rank</h3>
                        <p className="text-xs font-bold text-primary uppercase tracking-tight">{title}</p>
                    </div>
                </div>
